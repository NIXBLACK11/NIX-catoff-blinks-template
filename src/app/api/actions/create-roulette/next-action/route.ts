...
export const POST = async (req: Request) => {
  try {
    ...
    const message = `Your roulette game has been created successfully! Join using blink: [https%3A%2F%2Fdial.to%2F%3Faction%3Dsolana-action%3Ahttps%3A%2F%2Froulette.nixblack.site%2Fapi%2Factions%2Fjoin-roulette%3FgameId%3D${rouletteGame.id}%26name%3D${rouletteGame.name}%26clusterurl%3D${clusterurl}]`
